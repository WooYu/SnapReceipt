...
class GetReceiptsByTypeUseCase @Inject constructor(
    private val repository: ReceiptRepository
) {
    operator fun invoke(type: String): Flow<Result<List<ReceiptEntity>>> =
        repository.getReceiptsByType(type).asResult()
}
